...
print("  sales\ttotal_pay")
print("-------------------------")

#print values for different amount of sales 
for amount in range (start_sales, end_sales+1, increment) : 
    #calculate the salary based on the amount of sales 
    salary = base_pay + bonus_percent * amount
    print('$',amount, '\t$',salary, sep='') 
    # or, optionally 
    #print('$'+format(amount,'.2f'), '$'+format(salary,'.2f'), sep='\t') 

...
count_war = data.lower().count("war")
count_peace = data.lower().count("peace")
count_and = data.lower().count("and")
    
print("'war' appears ", count_war, "times")
print("'and' appears ", count_and, "times")
print("'peace' appears ", count_peace, "times")